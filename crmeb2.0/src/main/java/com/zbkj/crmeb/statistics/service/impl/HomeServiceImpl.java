...
public class HomeServiceImpl implements HomeService {
    ...
    public HomeRateResponse sales() {
        //根据日期范围统计销售额
        BigDecimal today = storeOrderService.getSumBigDecimal(null, Constants.SEARCH_DATE_DAY,null,false); // 今日销售额
        BigDecimal yesterday = storeOrderService.getSumBigDecimal(null, Constants.SEARCH_DATE_YESTERDAY,null,false);   //昨天销售额
        BigDecimal week = storeOrderService.getSumBigDecimal(null, Constants.SEARCH_DATE_WEEK,null,false); //本周销售额
        BigDecimal preWeek = storeOrderService.getSumBigDecimal(null, Constants.SEARCH_DATE_PRE_WEEK,null,false);  //上周销售额
        BigDecimal all = storeOrderService.getSumBigDecimal(null, null,null,false);    //总销售额
    ...
    public HomeRateResponse order() {
        ///今日数量
        int today = storeOrderService.getOrderCount(null, null,Constants.SEARCH_DATE_DAY);

        //昨日数量
        int yesterday = storeOrderService.getOrderCount(null,null, Constants.SEARCH_DATE_YESTERDAY);

        //本周数量
        int week = storeOrderService.getOrderCount(null,null, Constants.SEARCH_DATE_WEEK);

        //上周数量
        int preWeek = storeOrderService.getOrderCount(null,null, Constants.SEARCH_DATE_PRE_WEEK);

        //总数量
        int all = storeOrderService.getOrderCount(null, null,null);
