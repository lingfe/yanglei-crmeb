...
public class StoreOrderController {
    ...
    @ApiOperation(value = "给联盟商家发货",notes = Constants.SELECT)
    @RequestMapping(value = "/isLmsjfahuo", method = RequestMethod.GET)
    @ApiImplicitParam(name = "id", value = "订单ID标识", required = true)
    public CommonResult<Boolean> isLmsjfahuo(@RequestParam("id")Integer id){
        return CommonResult.success(storeOrderService.isLmsjfahuo(id));
    }

    @ApiOperation(value = "分页显示订单表") //配合swagger使用
    @RequestMapping(value = "/list", method = RequestMethod.GET)
    public CommonResult<CommonPage<StoreOrderDetailResponse>> getList(
