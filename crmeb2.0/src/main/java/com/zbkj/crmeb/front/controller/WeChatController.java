...
public class WeChatController {
     ...
     * @throws
     * @title weChatLogin
     * @description 微信-授权app登录
     * @author 零风
     * @updateTime 2019-9-12 16:00:51
     */
    @ApiOperation(value = "微信-授权APP登录")
    @RequestMapping(value = "/app/weChatLogin",method = RequestMethod.GET)
    protected CommonResult<LoginResponse> weChatAppLogin(@RequestParam("data") String data) {
        return CommonResult.success(userCenterService.weChatAppLogin(data));
    }
