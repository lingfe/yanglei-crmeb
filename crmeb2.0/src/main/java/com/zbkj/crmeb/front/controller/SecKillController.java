...
public class SecKillController {
    ...
    @ApiOperation(value = "设置预约乘以人数配置")
    @RequestMapping(value = "/setMaaRideNum", method = RequestMethod.GET)
    public CommonResult<Boolean> setMaaRideNum(@PathVariable(value = "num") Integer num){
        return CommonResult.success(storeSeckillService.setMaaRideNum(num));
    }
