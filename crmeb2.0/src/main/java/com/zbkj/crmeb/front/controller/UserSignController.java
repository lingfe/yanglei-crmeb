 ...
 */
@Slf4j
@RestController("UserSignController")
...
public class UserSignController {
    ...
    @RequestMapping(value = "/suppSign", method = RequestMethod.GET)
    @ApiImplicitParam(name="date", value="日期")
    public CommonResult<SystemGroupDataSignConfigVo> suppSign(@RequestParam(value = "date") String date){
        return CommonResult.success(userSignService.suppSign(date));
    }
