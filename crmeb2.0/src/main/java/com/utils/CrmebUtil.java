...
public class CrmebUtil {
     ...
     * @return
     */
    public static String decryptZijie(String encryptedData, String sessionKey, String iv) throws NoSuchPaddingException,
    ...
    public static String encryptPassword(String pwd, String key){
        try {
             ...
             * /D:/lingfe/gitee/shop_sys/crmeb/crmeb_java/crmeb/src/main/java/com/utils/CrmebUtil.java:[46,32] sun.misc.BASE64Encoder是内部专用 API, 可能会在未来发行版中删除
             * /D:/lingfe/gitee/shop_sys/crmeb/crmeb_java/crmeb/src/main/java/com/utils/CrmebUtil.java:[62,35] sun.misc.BASE64Decoder是内部专用 API, 可能会在未来发行版中删除
    ...
    public static String decryptPassowrd(String pwd, String key)
        ...
        byte[] data = new Base64().decodeBase64(pwd);
        byte[] result = cipher.doFinal(data);
    ...
    public static String getOrderNoPrefix(String payType){
        switch (payType){
            case PayConstants.PAY_TYPE_WE_CHAT:
                return PayConstants.ORDER_NO_PREFIX_WE_CHAT;
                //其他平台
            default:
                return PayConstants.ORDER_NO_PREFIX_H5;
        }
    }
