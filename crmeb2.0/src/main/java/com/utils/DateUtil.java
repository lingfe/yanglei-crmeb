...
public final class DateUtil {
    ...
    /**
     * 计算解冻时间
     * @param frozenTime 冻结期时间（天）
     * @Author 零风
     * @Date  2022/2/18
     * @return
     */
    public static Long calculationThawDatetime(Integer frozenTime) {
        Long thawTime = cn.hutool.core.date.DateUtil.current();//.current(false);
        if (frozenTime > 0) {
            DateTime dateTime = cn.hutool.core.date.DateUtil.offsetDay(new Date(), frozenTime);
