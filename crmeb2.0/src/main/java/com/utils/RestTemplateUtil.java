...
//        headers.setContentType(MediaType.MULTIPART_FORM_DATA);
    ...
    public String postWXRefundXml(String url, String xml, String mchId, String path) throws Exception {
        ...
        SSLConnectionSocketFactory sslConnectionSocketFactory = new SSLConnectionSocketFactory(
                sslContext,
                //参考链接 https://developers.weixin.qq.com/community/develop/doc/000a00acea86e052e1494360456c00?highLine=No%2520appropriate%2520protocol
                //new String[]{"TLSv1"},
               // null,
